...
class Snake {
    constructor() {
        ...
        this.head = document.querySelector('#snake > div'); // querySelector()函数只取一个元素
        // querySelectorAll 可以获取列表！重点，和querySelector区别
        this.bodies = (_a = document.getElementById('snake')) === null || _a === void 0 ? void 0 : _a.getElementsByTagName('div'); //?表示存在则执行
    }
    // 蛇坐标就是蛇头坐标
    get X() {
    ...
    moveBody() {
        ...
        for (let i = this.bodies.length - 1; i > 0; i--) {
            ...
            // 将这个值设置到当前身体
            this.bodies[i].style.left = X + 'px'; // 类型断言
            this.bodies[i].style.top = Y + 'px'; // 类型断言
        }
    }
    checkHeadBody() {
